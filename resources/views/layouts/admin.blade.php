...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('yangiliklar.index')}}">
                    <i style="font-size:18px;" class="fas fa-thin fa-book"></i>
            ...
            <li class="nav-item">
                ...
                @else
                <a class="nav-link" href="{{route('hodimlar.showh')}}">
                    <i style="font-size:18px;" class="fa-solid fa-user-tie"></i>
                    <span>Mening ma'lumotlarim</span></a>
                @endif;
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline  " style="font-size:20px;color:#1E90FF;">{{auth()->user()->name}}</span>
